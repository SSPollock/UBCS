...
namespace CoreConcepts.Pages.Services
{
    public class StockPrices : IStocks
    {
        ...
        { 
            ...
            { 
                string path = "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=" + sinfo.Symbol + "&apikey= C0RPL68JC9QTEBFRZ"; 
        ...
        {             
            ...
            {                 
                ...
                string pricePart = (from s in parts where s.IndexOf("price") >= 0 select s).FirstOrDefault<string>();
