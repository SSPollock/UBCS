...
namespace CoreConcepts.Pages
{
    public class MyConfigOptionsModel : PageModel
    {
        ...
        public MyConfigOptionsModel(
            IOptions<CompanyOptions> copt, 
            IOptions<EmailSettingsOptions> emopt) 
        { 
            _copt = copt; 
            _emopt = emopt; 
        } 
        ...
        public void OnGet()
        {
            ...
            string out1 = "Company Name:" + companyName + "<br/>" + "Manager:" + 
            ...
            string out2 = "Email From:" + emailFrom + "<br/>" + "Subject:" + 
                emailSubject + "<br/>" + " SMPT:" + emailSmtp + "<br/>"; 
